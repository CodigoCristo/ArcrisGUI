...
typedef enum {
    ...
    VIDEO_DRIVER_NVIDIA_OPEN,
    VIDEO_DRIVER_NVIDIA_OPEN_LTS,
    VIDEO_DRIVER_NVIDIA_OPEN_DKMS,
    VIDEO_DRIVER_NVIDIA_580XX,
    VIDEO_DRIVER_NVIDIA_470XX,
    VIDEO_DRIVER_NVIDIA_390XX,
    VIDEO_DRIVER_NVIDIA_340XX,
    VIDEO_DRIVER_MESA_AMBER,
