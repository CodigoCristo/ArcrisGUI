...
if [ "${FILESYSTEMS_ENABLED:-false}" = "true" ]; then
    ...
    install_pacman_chroot_with_retry "gvfs-dnssd"
    ...
    install_pacman_chroot_with_retry "gvfs-onedrive"
    install_pacman_chroot_with_retry "gvfs-smb"
    install_pacman_chroot_with_retry "gvfs-wsdd"
...
if [ "${VIDEO_CODECS_ENABLED:-false}" = "true" ]; then
    ...
    install_pacman_chroot_with_retry "grilo-plugins"
    install_pacman_chroot_with_retry "gst-libav"
