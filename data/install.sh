    ...
    "DESKTOP")
        ...
        case "$DESKTOP_ENVIRONMENT" in
            ...
            "CINNAMON")
                ...
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S mint-l-theme --noansweredit --noconfirm --needed"
                ...
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S mint-artwork --noansweredit --noconfirm --needed"
                ...
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S xplayer --noansweredit --noconfirm --needed"
               	arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S loupe --noansweredit --noconfirm --needed"
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S gnome-screenshot --noansweredit --noconfirm --needed"
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S xviewer --noansweredit --noconfirm --needed"
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S lightdm --noansweredit --noconfirm --needed"
                arch-chroot /mnt /bin/bash -c "sudo -u $USER yay -S lightdm-gtk-greeter --noansweredit --noconfirm --needed"
                arch-chroot /mnt /bin/bash -c "systemctl enable lightdm"
                ;;
